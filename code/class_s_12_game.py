...
class S_12_Game(Two_Game):
    ...
    def __init__(self, c, b1, b2, eps=0.01, stored_stationary_dists={}):
        self.strat_len = 12
        self.max_num_strategies = 2**12

        super().__init__(c, b1, b2, eps, stored_stationary_dists)


    def generate_transition_matrix(self, s1, s2):
        [p1cc, p1cd, p1dc, p1dd, p2cc, p2cd, p2dc, p2dd, xcc, xcd, xdc, xdd] = \
            self.to_strategy(s1)
        [q1cc, q1cd, q1dc, q1dd, q2cc, q2cd, q2dc, q2dd, ycc, ycd, ydc, ydd] = \
            self.to_strategy(s2)
