class Pure_12_Game:
    ...
    # Strategies in [0,1]^12

    max_num_strategies = 2**12
    ...
    def mc_estimate(self, s1, s2, n = 20, initial_state = 0):
        ...
        s1 = Pure_12_Game.to_strategy(s1)
        s2 = Pure_12_Game.to_strategy(s2)
        ...
        for i in range(n):
            ...
            curr_state = Pure_12_Game.states[(curr_game, s1_move, s2_move)]
