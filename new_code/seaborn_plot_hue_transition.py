...
img_folder = "imgs/not_full_runs/transitions/"
img_filename = strat + "_transitions_part.png"
...
data0 = pd.read_csv(folder + strat + "_EqualSay_G2_Default.csv")
data1 = pd.read_csv(folder + strat + "_EqualSay_G1_Default.csv")
data2 = pd.read_csv(folder + strat + "_Player1_Dictator.csv")
data3 = pd.read_csv(folder + strat + "_Random_Dictator.csv")
...
all_data = [data0, data1, data2, data3] #[data1, data2, data3, data4]
...
g.set_title('{:s}: Effect of Transition Dynamics on Cooperation Rate'.format(strat))
